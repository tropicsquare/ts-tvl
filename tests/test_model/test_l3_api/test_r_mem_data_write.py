...
@pytest.mark.parametrize("prepare_data_free", UtilsRMem.VALID_INDICES, indirect=True)
...
@pytest.mark.parametrize("prepare_data_written", UtilsRMem.VALID_INDICES, indirect=True)
