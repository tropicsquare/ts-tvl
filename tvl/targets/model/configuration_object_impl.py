# GENERATED ON 2025-06-27 14:13:00.917461
# BY CO_GENERATOR VERSION 0.4
# INPUT FILE: 4c42063cbc7c11a0d887b73ebe306c166716563a23f1acc2be88316747644a15
#
...
class CfgUapEddsaVerify(ConfigObjectRegister):
    eddsa_verify_ecckey_slot_0_7 = ConfigObjectField(0, 8)
    """Access privileges of the EDDSA_Verify L3 Command packet to keys from
    ECC Key slots 0-7."""
    eddsa_verify_ecckey_slot_8_15 = ConfigObjectField(8, 8)
    """Access privileges of the EDDSA_Verify L3 Command packet to keys from
    ECC Key slots 8-15."""
    eddsa_verify_ecckey_slot_16_23 = ConfigObjectField(16, 8)
    """Access privileges of the EDDSA_Verify L3 Command packet to keys from
    ECC Key slots 16-23."""
    eddsa_verify_ecckey_slot_24_31 = ConfigObjectField(24, 8)
    """Access privileges of the EDDSA_Verify L3 Command packet to keys from
    ECC Key slots 24-31."""
