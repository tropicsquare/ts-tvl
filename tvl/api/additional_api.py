...
from .l2_api import TsL2EncryptedCmdRequest, TsL2EncryptedCmdResponse
...
class L2EncryptedCmdChunk(L2Request, id=TsL2EncryptedCmdRequest.ID):
    encrypted_cmd: U8Array = datafield(min_size=0, max_size=ENCRYPTED_PACKET_MAX_SIZE)


class L2EncryptedResChunk(L2Response, id=TsL2EncryptedCmdResponse.ID):
