# GENERATED ON 2024-11-07 15:00:49.530103
...
class L2Enum(HexReprIntEnum):
    ...
    STARTUP = 0xB3
    """Reset the chip."""
    MUTABLE_FW_UPDATE = 0xB1
    """Write new FW."""
    MUTABLE_FW_ERASE = 0xB2
    """Erase FW."""
    GET_LOG = 0xA2
    """Get FW log"""
...
class TsL2MutableFwEraseRequest(L2Request, id=L2Enum.MUTABLE_FW_ERASE):
...
class TsL2MutableFwEraseResponse(L2Response, id=L2Enum.MUTABLE_FW_ERASE):
    pass
...
class L2API(BaseModel):
    ...
    @api("l2_api")
    def ts_l2_mutable_fw_erase(
        self, request: TsL2MutableFwEraseRequest
    ) -> Union[TsL2MutableFwEraseResponse, List[TsL2MutableFwEraseResponse]]:
